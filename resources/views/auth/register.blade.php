    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style="border: none;border-radius: 25px;">
                <div class="card-header" style="background: #3681f7; color: white;">{{ trans('sentence.register') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ trans('sentence.email.login') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ trans('sentence.Confirm') }}</label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-4 offset-md-5">
                                <button style="border-radius: 50px;width: 100%" type="submit" class="btn btn-primary">
                                    {{ trans('sentence.register') }} <i class="fa fa-check"></i>
                                </button>
                            </div>
                        </div>
                    </form>
